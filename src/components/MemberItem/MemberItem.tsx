...
const MemberItem: FC<MemberItemProps> = ({ member }) => {
    const avatar = member?.user?.avatarPath ? `https://www.east-calendar.ru/${member?.user?.avatarPath}` : 'https://i.pinimg.com/736x/61/8e/b9/618eb95d5194903a7ab2a6641f152bd0.jpg'
